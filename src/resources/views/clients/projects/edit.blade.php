...
@section('content')
    ...
    <div class="area project_add_new" id="project_tab">
        ...
        <h2 class="d-flex position-relative new-project">Edit Project</h2>
        ...
        <div>
            <div class="d-flex group-input">
                ...
                <input placeholder="Try a team name, project goal, milestone..." value="{{ $project->name }}" name="name">
            </div>
            <div class="d-flex group-input">
                <p class="input_caption">Key<sup>*</sup></p>
                <input placeholder="Project Key is Unique" value="{{ $project->project_key }}" name="project_key">
            </div>
            <div class="d-flex group-input">
